...
namespace ChillLancer.API.Controllers
{
    ...
    public class TransactionController : Controller
    {
        ...
        public async Task<IActionResult> AddPayment(Guid orderId, Guid userId)
        {
            ...
            var process = await _processService.GetProcessById(userId);
            try
            {
        ...
        public async Task<IActionResult> PaymenCalltBack()
        {
            ...
            if (responseCode != "00")
            {
                ...
                if (updateResult)
                {
                    //return Redirect("https://localhost:7005/Payments/PaymentFailed");
                }
            ...
            {
                var updateResult = await _processService.UpdateStatus("Completed", processId);
                if (updateResult)
                {
                    //return Redirect("https://localhost:7005/Payments/PaymentSuccess");
                }
